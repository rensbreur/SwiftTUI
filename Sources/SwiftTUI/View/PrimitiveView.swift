...
///
/// Primitive views have complete control of how they build and update nodes. We can generally put
/// them into one of four categories (note that a view is a description of how to create a **list**
/// of controls):
///
/// * Ones that manage a single control.
///
/// * Ones that let a user specify a collection of other views.
///
